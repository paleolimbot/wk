...
typedef struct {
  ...
  int dirty;
  void* handler_data;
  int (*vector_start)(const wk_meta_t* meta, void* handler_data);
  int (*feature_start)(const wk_meta_t* meta, uint64_t feat_id, void* handler_data);
  int (*null_feature)(const wk_meta_t* meta, uint64_t feat_id, void* handler_data);
  ...
  int (*feature_end)(const wk_meta_t* meta, uint64_t feat_id, void* handler_data);
  SEXP (*vector_end)(const wk_meta_t* meta, void* handler_data);
  int (*error)(uint64_t feat_id, int code, const char* message, void* handler_data);
