...
typedef struct {
  ...
  int (*feature_start)(const wk_vector_meta_t* meta, uint64_t feat_id, void* handler_data);
  int (*null_feature)(const wk_vector_meta_t* meta, uint64_t feat_id, void* handler_data);
  ...
  int (*feature_end)(const wk_vector_meta_t* meta, uint64_t feat_id, void* handler_data);
