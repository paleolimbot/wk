...
typedef struct {
  ...
  int (*feature_start)(const wk_meta_t* meta, R_xlen_t feat_id, void* handler_data);
  int (*null_feature)(const wk_meta_t* meta, R_xlen_t feat_id, void* handler_data);
  ...
  int (*feature_end)(const wk_meta_t* meta, R_xlen_t feat_id, void* handler_data);
