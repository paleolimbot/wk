...
The wk package has one recursive dependency ([cpp11](https://cpp11.r-lib.org)), compiles in ~10 seconds, and runs all 600 expectations in ~4 seconds. The package can read and write WKB at approximately the same speed as the sf package.
