...
int bump_trans_trans(R_xlen_t feature_id, double* xyzm_in, double* xyzm_out, void* trans_data) {
...
The rules are still evolving since this is a new feature but in general you should never throw exceptions or error in your transform function (instead return `WK_ABORT` and error in `vector_end()`).
